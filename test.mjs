...
r = parse(await I.setSkillDisabled('disable-me', true, SKILLS))
...
r = parse(await I.setSkillDisabled('disable-me', false, SKILLS))
...
r = parse(await I.setSkillDisabled('market-skill', true, SKILLS))
check('disable non-agent skill allowed (no delete, just flag)', r.success, JSON.stringify(r))
r = parse(await I.setSkillDisabled('market-skill', false, SKILLS))
...
await I.setSkillDisabled('market-skill', false, SKILLS)
await I.editSkill('market-skill', '---\nname: market-skill\ndescription: installed from marketplace.\n---\nbody\n', SKILLS)
